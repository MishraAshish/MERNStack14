...
let UserHook = (props) => {
    ...
    let dispatchUser = useDispatch(); //mapDispatchToProps
    ...
    let readFormData = (evt)=>{
        ...
        dispatchUser(signInSignUpUser(user)); 
    ...
    return(
        <>
            ...
            <form className={"form col-md-10 userHook"} onSubmit={readFormData} action="/api/saveUser">
